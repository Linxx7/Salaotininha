    ...
    <section className="flex min-h-[70vh] items-center bg-[#faf8f6] px-4 py-24 dark:bg-wine-900">
      <SectionContainer narrow>
        <div className="text-center">
          ...
          <h1 className="mt-4 font-serif text-4xl font-bold text-gray-900 dark:text-white sm:text-5xl">
            Ops! Erro inesperado
          </h1>
          ...
          <div className="mt-12 border-t border-wine-100 pt-8 dark:border-wine-700">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <Link href="/agendamento" className="text-sm text-wine-600 hover:text-wine-800 dark:text-wine-300 dark:hover:text-white">
                Agendamento
              </Link>
