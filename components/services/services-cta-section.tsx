    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-0
                   bg-[radial-gradient(ellipse_80%_60%_at_110%_50%,theme(colors.wine.700/0.5),transparent)]
                   dark:bg-[radial-gradient(ellipse_80%_60%_at_110%_50%,theme(colors.wine.800/0.6),transparent)]"
        aria-hidden="true"
      />
      ...
      <SectionContainer className="relative z-10">
        <div className="max-w-xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-wine-200 dark:text-wine-300">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Button
              ...
              className="rounded-full border border-white/20 bg-white px-8 text-xs font-semibold uppercase tracking-widest text-wine-800 shadow-md transition-all hover:bg-wine-50 hover:shadow-lg
                         dark:bg-wine-100 dark:text-wine-900 dark:hover:bg-white"
            >
            ...
            <Button
              ...
              className="rounded-full border border-wine-600 px-8 text-xs font-semibold uppercase tracking-widest text-wine-100 hover:border-wine-400 hover:bg-wine-700/50 hover:text-white
                         dark:border-wine-700 dark:text-wine-200 dark:hover:border-wine-500 dark:hover:bg-wine-900/60"
            >
